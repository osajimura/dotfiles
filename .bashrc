...
export PATH="$PYENV_ROOT/shims:~/local/bin:/usr/local/bin:/opt/homebrew/bin:/sbin:/bin:/usr/bin:/usr/sbin:~/xgear_install/xgear/bin"
...
gb() {
    ...
    git checkout -f $(echo "$branch" | awk '{print $1}')
}
